...
import com.xiongyayun.athena.service.websocket.model.WebSocketUserAuthentication;
...
public class WebSocketChannelInterceptor implements ChannelInterceptor {
    ...
    public void postSend(Message<?> message, MessageChannel channel, boolean sent) {
        ...
        log.info("SessionId: {}, SubscriptionId: {}, Host: {}, User: {}, Destination: {}", accessor.getSessionId(), accessor.getSubscriptionId(), accessor.getHost(), accessor.getUser(), accessor.getDestination());
        if (httpSession != null) {
...
//        }
     ...
     */
    @Override
    public void afterSendCompletion(Message<?> message, MessageChannel channel, boolean sent, @Nullable Exception e) {
