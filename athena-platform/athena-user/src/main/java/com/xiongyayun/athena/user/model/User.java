...
public class User implements Serializable {
    ...
    @TableField(value = "`user_name`", condition = SqlCondition.LIKE_RIGHT)
    ...
    @TableField(value = "`last_visit_ip`", fill = FieldFill.INSERT_UPDATE)
    ...
    @TableField(value = "`last_visit_date`", fill = FieldFill.INSERT_UPDATE)
